...
class Graph:
    ...
    def add_edge(self, v1, v2):
        ...
        if v1 in self.vertices and v2 in self.vertices:
            ...
            raise IndexError("vertex dont exist")
    ...
    def get_neighbors(self, vertex_id):
        ...
        if vertex_id in self.vertices:
            ...
            raise ValueError('vortex not found')
    ...
    def bfs(self, starting_vertex, destination_vertex):
        ...
        q.enqueue([starting_vertex])
        # Create a set to store the shortest path
        visited = set()
        # While the queue is not empty...
        while q.size() > 0:     
    ...
    def dfs(self, starting_vertex, destination_vertex):
        ...
        # create a queue
        s = Stack()
        # push a path for the starting vertex
        s.push([starting_vertex])
        # Create a set to store the shortest path
        visited = set()
        # While the queue is not empty...
    ...
    def dfs_recursive(self, starting_vertex,destination_vertex, visited=set(), path=[]):
        ...
        #if starting_vetex == target_vortex
        #return  path
        #for neightbors in neighbors(starting_vertex):
        #if neightbor not in visited
        #make copy of path
        #new_path = def_recursive(neighbor, target_vertex, visited, path)
        #if new_path return new path
